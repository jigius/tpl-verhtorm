    ...
    (function () {
      ...
      (function () {
        ...
        const update = function () {
          const resetAll = $('#filter .tf-filter-reset[data-tf-reset="all"]');
          const minPrice = $('#filter input[name="tf_fp[min]"]');
          const maxPrice = $('#filter input[name="tf_fp[max]"]');
          if (
            $('#filter').find('.check-input[name]:checked').length > 0 ||
